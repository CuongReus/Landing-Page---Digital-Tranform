...
?>
<!-- ==============Banner=============== -->
<section id="banner" class="flex flex-wrap align-center relative">
  <div class="gap-block"></div>
  <div class="text-banner">
    <h1 class="title-banner uppercase t-center"> <?php echo $title_main_block_one ?> </h1>
  ...
  <div class="custom-shape-divider-top-1600051358">
...
<!-- ======================================================= -->
<!-- ================Khái niệm chuyển đổi số================ -->
<section id="digital-tranfor" class="relative" style="background-image: url('<?php echo $image_background_block_two['url']; ?>')">
  <div class="gap-block"></div>
  <h2 class="title-heading c-white t-center"> <?php echo $title_main_block_two ?> </h2>
  ...
  <div class="content-digital-tranfor relative">
    ...
    <div class="digital-tranfor-text container p-md t-center c-white">
    ...
    <div class="object-target">
      ...
      <?php if (have_rows('des_block_three')) : ?>
        <ul class="object-target-list remove-dot c-white relative">
          ...
          ?>
            <li class="object-target-item absolute flex align-center justify-center t-center bold uppercase"> <?php echo $target_block_three ?> </li>
          <?php endwhile; ?>
        </ul>
      <?php endif; ?>
    </div>
...
<section id="process">
  ...
  <div class="gap-el"></div>
  <div class="wrapper-process-steps relative" style="background-image: url('<?php echo $image_background_block_four['url']; ?>')">
    <?php if (have_rows('des_block_four')) : ?>
      <ul class="process-steps-list remove-dot flex align-center">
    ...
    <div class="bottom-right-main">
      <?php if (have_rows('des_block_five')) : ?>
        <ul class="five-main-list remove-dot flex justify-center c-white">
          ...
          ?>
            <li class="five-main-item mr-md p-sm bold relative">
...
<section id="price-table" class="bg-light">
  <h2 class="title-heading t-center"> <?php echo $title_main_block_six ?> </h2>
  <p class="t-center p-sm"> <?php echo $content_sub_block_six ?> </p>
  <div class="line-heading flex justify-center align-center">
    <span class="circle"></span>
    <span class="circle"></span>
    <span class="circle"></span>
  ...
  <div class="gap-block"></div>
  <ul class="price-table-list container grid grid-3 grid-gap-md">
    <?php if (have_rows('des_block_six')) : ?>
      ...
      ?>
        <li class="price-table-item flex flex-col align-center box-shadow relative p-md bg-white">
          <a href="">
...
<section id="customer" class="relative">
  ...
  <p class="t-center p-sm"> <?php echo $title_sub_block_seven ?> </p>
  <div class="line-heading flex justify-center align-center">
    <span class="circle"></span>
    <span class="circle"></span>
    <span class="circle"></span>
    ...
    <ul class="customer-list container grid grid-5">
      ...
      ?>
        <li class="customer-item flex align-center justify-center">
          <img class="customer-img bg-white img p-sm" src="<?php echo $avatar_customer_block_seven['url'] ?>" alt="<?php echo $avatar_customer_block_seven['alt'] ?>">
        </li>
      <?php endwhile; ?>
    </ul>
  <?php endif; ?>
...
<section id="contact">
  ...
  <div class="wrapper-contact container grid grid-2">
    <div class="contact-info">
      <h2 class="title-heading t-center"> <?php echo $title_left ?> </h2>
      <div class="line-heading flex justify-center align-center">
        <span class="circle"></span>
        <span class="circle"></span>
        <span class="circle"></span>
    ...
    <div class="suport">
      <h2 class="title-heading t-center"> <?php echo $title_right ?> </h2>
      <div class="line-heading flex justify-center align-center">
        <span class="circle"></span>
        <span class="circle"></span>
        <span class="circle"></span>
